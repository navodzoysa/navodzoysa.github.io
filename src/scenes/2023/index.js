import { Container, createStyles, Title, Text, Flex, rem, Footer, Grid, Card, Image, Anchor, Button, ThemeIcon, Group } from "@mantine/core";
					...
					>
						<Anchor href="https://github.com/navodzoysa/SecureBoot" target="_blank">
							<Card className={classes.grid1}>
								<Card.Section>
									<Image src={SecureBootImage} height="400"  />
								</Card.Section>
					...
					>
						<Anchor href="https://github.com/FallGuys-SDGP/Review-Insight" target="_blank">
							<Card className={classes.grid2}>
								<Card.Section>
									<Image src={ReviewInsighImage} height="400" />
								</Card.Section>
					...
					>
						<Anchor href="https://www.fieldr.lk/indoor-cricket-app-digital-scoresheet/" target="_blank">
							<Card  className={classes.grid3}>
								<Card.Section>
									<Image src={FieldRImage} height="400" fit="contain" />
								</Card.Section>
